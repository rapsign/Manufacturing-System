...
/**
* @see \App\Http\Controllers\Manager\ProductController::index
 * @see app/Http/Controllers/Manager/ProductController.php:13
...
/**
* @see \App\Http\Controllers\Manager\ProductController::create
 * @see app/Http/Controllers/Manager/ProductController.php:20
...
/**
* @see \App\Http\Controllers\Manager\ProductController::store
 * @see app/Http/Controllers/Manager/ProductController.php:25
 * @route '/manager/products'
 */
...
/**
* @see \App\Http\Controllers\Manager\ProductController::edit
 * @see app/Http/Controllers/Manager/ProductController.php:40
 * @route '/manager/products/{product}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/manager/products/{product}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\Manager\ProductController::update
 * @see app/Http/Controllers/Manager/ProductController.php:47
 * @route '/manager/products/{product}'
 */
...
/**
* @see \App\Http\Controllers\Manager\ProductController::destroy
 * @see app/Http/Controllers/Manager/ProductController.php:63
 * @route '/manager/products/{product}'
 */
